...
SECRET_KEY = 'django-insecure-6y8cp6dsrk&!^qvy)bg2@$gv0-(xr+z5&uy1nv4_3&o-kc05to'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tv.context_processors.donnees_context',  # Remplacez 'votre_app' par le nom de votre application
            ],
        },
    },
]
